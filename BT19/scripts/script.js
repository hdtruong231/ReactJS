...
function setPages(array, itemsPerPage) {
    ...
    for (let i = 1; i <= pages; i++) {
        html += `<button class="page ${i === 1 ? 'bg-blue-500 hover:bg-blue-70 font-bold text-white' : 'bg-gray-300 hover:bg-gray-500 text-black'}  font-bold py-2 px-4 rounded" data-page="${i}">${i}</button>`;
    }
